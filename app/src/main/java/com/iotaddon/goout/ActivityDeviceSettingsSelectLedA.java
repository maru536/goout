...
public class ActivityDeviceSettingsSelectLedA extends AppCompatActivity {
    ...
    class ItemAdapter extends RecyclerView.Adapter<ActivityDeviceSettingsSelectLedA.ItemAdapter.ViewHolder> {
        ...
        @Override
        public ActivityDeviceSettingsSelectLedA.ItemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_select_led, parent, false);
            ActivityDeviceSettingsSelectLedA.ItemAdapter.ViewHolder holder = new ActivityDeviceSettingsSelectLedA.ItemAdapter.ViewHolder(view);
            return holder;
        }

        @Override
        public void onBindViewHolder(ActivityDeviceSettingsSelectLedA.ItemAdapter.ViewHolder holder, final int position) {
